...
var calmAudio = new Audio(
  "./assets/music/background/calm_game_music_1-49209.mp3"
);
var clockTickAudio = new Audio(
  "./assets/music/background/clock-tick-76039.mp3"
);
var lofiAudio = new Audio(
  "./assets/music/background/lofi-chill-medium-version-159456.mp3"
);
var runningWaterAudio = new Audio(
...
var audioStartPomodoro = new Audio(
  "./assets/music/init_pomodoro/default-decide.mp3"
);
var audioLosePomodoro = new Audio(
  "./assets/music/lose_pomodoro/game-over-arcade-6435.mp3"
);
var audioSucessPomodoro = new Audio(
  "./assets/music/sucess_pomodoro/success-1-6297.mp3"
);
var audioBackground = fireAudio;
var audioEndBreak = new Audio(
